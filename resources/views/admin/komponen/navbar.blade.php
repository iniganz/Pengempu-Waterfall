  <header class="navbar sticky-top bg-dark flex-md-nowrap p-0 shadow" data-bs-theme="dark"> <a
            class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white neonText" href="/">Cuynest.</a>
        <ul class="navbar-nav flex-row d-md-none" id="NavbarNav">
...
<script>
  document.addEventListener("DOMContentLoaded", function () {
    if (window.innerWidth < 768) { // kurang dari breakpoint md
